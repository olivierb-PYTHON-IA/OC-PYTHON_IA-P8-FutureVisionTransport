...
model = get_unet_model(img_size=img_size, num_cats=num_cats)
...
callbacks=[
    ...
    ModelCheckpoint('cityscape-fs-unet-aug.h5', save_best_only=True, verbose=1),
    LogRunMetrics()
]
...
model.save('./outputs/cityscape-fs-unet-aug.h5')
run.upload_file('./outputs/cityscape-fs-unet-aug.h5', './outputs/cityscape-fs-unet-aug.h5')


# Enregistrement du modèle
run.register_model(model_name='cityscape-fs-unet-aug.h5', model_path='./outputs/cityscape-fs-unet-aug.h5')
