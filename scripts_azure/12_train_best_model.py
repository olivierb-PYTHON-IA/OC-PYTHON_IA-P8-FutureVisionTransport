...
callbacks=[
    ...
    ModelCheckpoint('cityscape-best-model.h5', save_best_only=True, verbose=1),
    LogRunMetrics()
]
...
model.save('./outputs/cityscape-best-model.h5')
run.upload_file('./outputs/cityscape-best-model.h5', './outputs/cityscape-best-model.h5')


# Enregistrement du modèle
run.register_model(model_name='cityscape-best-model.h5', model_path='./outputs/cityscape-best-model.h5')
