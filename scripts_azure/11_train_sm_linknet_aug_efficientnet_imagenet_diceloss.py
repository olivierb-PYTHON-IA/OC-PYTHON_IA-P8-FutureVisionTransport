...
# Modèle
model = sm.Linknet(BACKBONE, classes=num_cats, activation='softmax', encoder_weights='imagenet', encoder_freeze=False)
...
callbacks=[
    ...
    ModelCheckpoint('cityscape-sm-linknet-aug-efficientnet-imagenet-diceloss.h5', save_best_only=True, verbose=1),
    LogRunMetrics()
]
...
model.save('./outputs/cityscape-sm-linknet-aug-efficientnet-imagenet-diceloss.h5')
run.upload_file('./outputs/cityscape-sm-linknet-aug-efficientnet-imagenet-diceloss.h5', './outputs/cityscape-sm-linknet-aug-efficientnet-imagenet-diceloss.h5')


# Enregistrement du modèle
run.register_model(model_name='cityscape-sm-linknet-aug-efficientnet-imagenet-diceloss.h5', model_path='./outputs/cityscape-sm-linknet-aug-efficientnet-imagenet-diceloss.h5')
