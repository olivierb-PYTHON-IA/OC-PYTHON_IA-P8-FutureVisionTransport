...
callbacks=[
    ...
    ModelCheckpoint('cityscape-sm-unet-aug-vgg-imagenet.h5', save_best_only=True, verbose=1),
    LogRunMetrics()
]
...
model.save('./outputs/cityscape-sm-unet-aug-vgg-imagenet.h5')
run.upload_file('./outputs/cityscape-sm-unet-aug-vgg-imagenet.h5', './outputs/cityscape-sm-unet-aug-vgg-imagenet.h5')


# Enregistrement du modèle
run.register_model(model_name='cityscape-sm-unet-aug-vgg-imagenet.h5', model_path='./outputs/cityscape-sm-unet-aug-vgg-imagenet.h5')
